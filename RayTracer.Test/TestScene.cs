...
namespace RayTracer.Test
{
    public class TestScene
    {
        ...
        static TestScene()
        {
            ...
            MeshObj = new MeshObject(mesh.Vertices, mesh.Triangles.Select(t => (t.Vector1, t.Vector2, t.Vector3)).ToArray(), mesh.Normals, new OpaqueMaterial(1.2f, Color.Red, .8f, true));
            MeshObj.Normalize();
            ...
            Sphere = new MeshObject(mesh.Vertices, mesh.Triangles.Select(t => (t.Vector1, t.Vector2, t.Vector3)).ToArray(), mesh.Normals,
